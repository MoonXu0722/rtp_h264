...
#define H264_FILE_NAME   "hama.h264"
#define SERVER_PORT      8554
#define SERVER_RTP_PORT  55532
#define SERVER_RTCP_PORT 55533
#define BUF_MAX_SIZE     (1024*1024)
#define LOCAL_IP "172.16.0.162"
void init_winsock()
{
...
int main(int argc, char* argv[])
{
    ...
    if (bindSocketAddr(serverSockfd, LOCAL_IP, SERVER_PORT) < 0)
    {
    ...
    if (bindSocketAddr(serverRtpSockfd, LOCAL_IP, SERVER_RTP_PORT) < 0 ||
        bindSocketAddr(serverRtcpSockfd, LOCAL_IP, SERVER_RTCP_PORT) < 0)
    {
        printf("failed to bind addr\n");
        return -1;
    }
